    ...
    return (
      <div className="wrapper">
        <div className="form-wrapper">
          ...
          <h2>Definitions</h2>
          <p1>For the purposes of these Terms and Conditions:</p1>
          <ul>
            <li>
              <p1>
            ...
            <li>
              <p1>
                ...
                in this Agreement) refers to Corona virus rapid test data
                platform.
              </p1>
            </li>
            <li>
            ...
            <li>
              <p1>
                <strong>Website</strong> refers to Corona virus rapid test data
                platform, accessible from{" "}
                <a
                  href="http://www.coronavirusrapidtestdata.com"
                  rel="external nofollow noopener"
                >
                  http://www.coronavirusrapidtestdata.com
                </a>
              </p1>
            </li>
            <li>
          ...
          <ul>
            <li>By email: z.yu@student,fontys,nl</li>
          </ul>
        </div>
      </div>
    );
