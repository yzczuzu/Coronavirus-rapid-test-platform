    ...
    return (
      <div className="wrapper">
        <div className="form-wrapper">
          ...
          <h2>Definitions</h2>
          <p1>For the purposes of this Privacy Policy:</p1>
          <ul>
            <li>
              <p1>
            ...
            <li>
              <p1>
                ...
                in this Agreement) refers to Coronvirus rapid test data
                platform.
              </p1>
            </li>
            <li>
            ...
            <li>
              <p1>
                <strong>Country</strong> refers to: The Netherlands
              </p1>
            </li>
            <li>
              <p1>
            ...
            <li>
              <p1>
                <strong>Website</strong> refers to Coronvirus rapid test data
                platform, accessible from{" "}
                <a
                  href="www.coronvirusrapidtestdataplatform.com"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  www.coronvirusrapidtestdataplatform.com
                </a>
              </p1>
            </li>
            <li>
